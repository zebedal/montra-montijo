            ...
            <div className="relative min-h-[280px] lg:min-h-[460px]">
              ...
              <div className="absolute bottom-0 left-0 p-6 text-white sm:p-8">
                ...
                <p className="mt-2 max-w-md text-sm leading-6 text-white/85">
                  Uma montra digital dedicada aos negócios, serviços e comércio
                  da região.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center p-6 sm:p-10 lg:p-12">
              ...
              <div className="mt-7 grid gap-4 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
                <div className="rounded-xl bg-muted/50 p-4">
                  ...
                  <p className="mt-3 text-sm font-semibold">Negócios locais</p>
                ...
                <div className="rounded-xl bg-muted/50 p-4">
                  ...
                  <p className="mt-3 text-sm font-semibold">Pesquisa simples</p>
                ...
                <div className="rounded-xl bg-muted/50 p-4">
                  ...
                  <p className="mt-3 text-sm font-semibold">Informação útil</p>
